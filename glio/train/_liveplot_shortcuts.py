...
_SHORTCUTS = {
    ...
    "10metrics01": {
        "train dice mean": (1, 0, {"color" : "orange", "zorder" : 0, "linewidth" : 0.5, "ylim" : (0,1),}),
        "test dice mean": (1, 0, {"color" : "red", "zorder" : 1, "ylim" : (0,1),}),
        "train iou mean": (1, 0, {"color" : "lime", "zorder" : 0, "linewidth" : 0.5, "ylim" : (0,1),}),
        "test iou mean": (1, 0, {"color" : "green", "zorder" : 1, "ylim" : (0,1),}),
